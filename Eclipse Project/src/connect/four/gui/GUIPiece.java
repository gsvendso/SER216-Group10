...
public class GUIPiece extends JLabel {
	...
	public GUIPiece(int playerNum) {
		...
		ImageIcon redIcon = new ImageIcon(getClass().getResource(
				"/images/red_glow/glow1.png"));
		ImageIcon blueIcon = new ImageIcon(getClass().getResource(
				"/images/blue_glow/glow1.png"));
		if (playerNum == 0) {
			setIcon(redIcon);
			glowNum = 0;
			...
			setIcon(blueIcon);
			glowNum = 1;
			glow1 = new ImageIcon(getClass()
					.getResource("/images/blue_glow/glow1.png"));
			glow2 = new ImageIcon(getClass()
					.getResource("/images/blue_glow/glow2.png"));
			glow3 = new ImageIcon(getClass()
					.getResource("/images/blue_glow/glow3.png"));
			glow4 = new ImageIcon(getClass()
					.getResource("/images/blue_glow/glow4.png"));
		}
